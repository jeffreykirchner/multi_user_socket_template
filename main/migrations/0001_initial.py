...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('good_one_production', models.IntegerField(default=0, verbose_name='Good one amount produced')),
                ('good_two_production', models.IntegerField(default=0, verbose_name='Good two amount produced')),
                ('good_one_consumption', models.IntegerField(default=0, verbose_name='Good one amount consumed')),
                ('good_two_consumption', models.IntegerField(default=0, verbose_name='Good two amount consumed')),
                ('good_three_consumption', models.IntegerField(default=0, verbose_name='Good three amount consumed')),
                ('good_one_production_rate', models.IntegerField(default=0, verbose_name='Good one production setting 0-100')),
                ('good_two_production_rate', models.IntegerField(default=0, verbose_name='Good two production setting 0-100')),
